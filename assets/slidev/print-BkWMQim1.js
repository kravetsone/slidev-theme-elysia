import{d as p,_ as h,y as u,b as a,e as t,x as s,A as c,F as v,Z as f,o as l,$ as g,l as x,g as b}from"../modules/vue-CVPr9In-.js";import{u as y,h as N,c as m,b as k}from"../index-CcQcm5la.js";import{N as w}from"./NoteDisplay-CMLlDRj2.js";import"../modules/shiki-DvXQnsHn.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},B={class:"text-4xl font-bold mt-2"},D={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},A={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-main mb-8"},M=p({__name:"print",setup($){const{slides:d,total:_}=y();h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
